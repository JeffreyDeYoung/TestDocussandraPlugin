 ...
 */
public class TestSecPlugin extends SecurityPlugin
{

    public TestSecPlugin()
    {
    ...
    public void doValidate(HashMap<String, List<String>> headers, String requestedPath, HttpMethod method) throws PermissionDeniedException
    {
        ...
        System.setProperty("com.pearson.docussandra.testHeader_2", headers.get("testHeader_2").get(0));//set the first header as a system prop so we can confirm this was called in a test
    }
